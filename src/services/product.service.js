...
class ProductService {
  ...
  static async createProduct(type, payload) {
    ...
    if (!productClass)
      throw new BusinessLogicError('Invalid product type: ' + type);
  ...
  static async updateProduct(type, productId, payload) {
    ...
    if (!productClass)
      throw new BusinessLogicError(i18n.translate('messages.error006', type));

    // console.log('new productClass', productClass);
